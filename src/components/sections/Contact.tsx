    ...
    return (
        <>
            <div className={styles.background}>
                ...
                <h3 className={styles.description}>Просто оставьте свой e-mail, и мы приложим все усилия, чтобы Ваше виртуальное пространство стало реальностью! Мы сами с Вами свяжемся.</h3>
