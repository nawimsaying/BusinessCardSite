                    ...
                    <div className={styles.container}>
                        <div className={styles.info_block}>
                            <div className={styles.info_block_item}>
                                <img className={styles.image} src='./images/whyus_1.png' alt='4'></img>
                                <h2>Команда</h2>
                        ...
                        <div className={styles.info_block}>
                            <div className={styles.info_block_item}>
                                <img className={styles.image} src='./images/whyus_2.png' alt='4'></img>
                                <h2>Выгода</h2>
                        ...
                        <div className={styles.info_block}>
                            <div className={styles.info_block_item}>
                                <img className={styles.image} src='./images/whyus_3.png' alt='4'></img>
                                <h2>Гарантия</h2>
